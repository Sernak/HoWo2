...
export const filterAffairs = (affairs: Array<AffairType>, filter: FilterType): Array<AffairType> => { // need to fix any
    ...
    //     return affairs
    // }
    // let resultFilter = affairs.filter(fl => fl.priority === filter)
    return filter === 'all' ? affairs : affairs.filter(fl => fl.priority === filter)// need to fix
}
export const deleteAffair = (affairs: Array<AffairType>, _id: number): Array<AffairType> => { // need to fix any
    // need to fix
    // отбрасывай при помощи метода filter лишних affairs
    // let resultDelet = affairs.filter(dl => dl._id !== _id)
    return affairs.filter(dl => dl._id !== _id)
}
...
function HW2() {
    ...
    const deleteAffairCallback = (_id: number) => { // need to fix any
        ...
        let result = deleteAffair(affairs, _id)
        setAffairs(result)
    }
